...
function buildContext(search, randomValue = 0, initialStorage = {}) {
  ...
  for(const name of ['../app/music-score.js','performance.js','terrain-cache.js','touch-controls.js','mentor-sprite.js','mentor-animation.js','player-animation.js','mentor-voice.js','encounter-catalog.js','creature-sprites.js'])vm.runInContext(fs.readFileSync(path.join(root,name),'utf8'),sandbox,{filename:name});
